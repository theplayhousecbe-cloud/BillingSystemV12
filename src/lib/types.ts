...
export type PackageId = "games-food-149" | "kids-food-99" | "kids-above-10-149" | "games-only-99" | "cafe-only" | "custom";
...
export const PACKAGES: { id: PackageId; name: string; adultRate: number; kidRate: number; subsequentRate: number; description: string }[] = [
  ...
  { id: "kids-food-99", name: "2). 99 Kids <10 Package (Games + Food)", adultRate: 99, kidRate: 99, subsequentRate: 99, description: "1hr games + food for kids" },
  { id: "kids-above-10-149", name: "3). 149 Kids >10 Package (Games + Food)", adultRate: 149, kidRate: 149, subsequentRate: 99, description: "1hr games + food for kids above 10" },
  { id: "games-only-99", name: "4). 99 Games Only (No Food)", adultRate: 99, kidRate: 99, subsequentRate: 99, description: "1hr games only, no food" },
  { id: "cafe-only", name: "5). Cafe Only (No Time Charge)", adultRate: 0, kidRate: 0, subsequentRate: 0, description: "Only menu bill, no time charge" },
];
...
export interface Person {
  id: string;
  label: string;        // "A", "B", "C" …
  kind: "adult" | "kid" | "kid_above_10" | "games_only" | "cafe_only";
  joinedAt: number;
  leftAt?: number;
